...
╠> ${m('memes')}
╠> ${m('buildgi')}
║ Build Genshin Impact according to the character's name.
╚══✪
...
const textDonasi = () => {
    return `
Hi, thanks for using this bot, follow and support me on social media :
...
To support and develop this bot you can help by donating :
